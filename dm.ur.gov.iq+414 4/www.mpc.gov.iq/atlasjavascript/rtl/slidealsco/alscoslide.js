...
https://github.com/rip747/Yahoo-style-news-slider-for-jQuery
    ”ÿ— 136 · €ÌÌ— «·⁄—÷   «·’Ê—…
                       ...
                       · €Ì— ⁄œœ «·‰ﬁ·«  ›Ì «·”·«Ìœ «·Ê«Õœ «Ì ⁄‰œ «·÷€ÿ ⁄·Ï «·√”Â„ «·Ì„‰… Ê«·Ì”—Ï «‘ﬂ„ ’Ê—… Ì‰ ﬁ·      ”ÿ— 31
...
//var img = jQuery('<img width="562"  height="300"></img>');
		...
		var _viewAll = jQuery("<div class=\"jqans-pagination\"></div>").html(["<div class=\"jqans-pagination-controls\"><span class=\"jqans-pagination-controls-back\"><a href=\"#\" title=\"«·”«»ﬁ…\"></a></span><span class=\"jqans-pagination-controls-next\"><a href=\"#\" title=\"«· «·Ì…\"></a></span></div><div class=\"jqans-pagination-count\"><span class=\"jqans-pagination-count-start\">1</span> - <span class=\"jqans-pagination-count-end\">", settings.slideBy, "</span> «·„Ã„Ê⁄ «·ﬂ·Ì <span class=\"jqans-pagination-count-total\">", stories.length, "</span> </div>"].join(""));
