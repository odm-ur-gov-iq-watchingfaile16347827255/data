...
$('#ctrl-student_martual').on('change', function(){ 
	var sm = $(this).val();
	if(sm==1){
	$('.nsf1').show();
    }else{
...
$('#ctrl-Do_you_have_relatives').on('change', function(){ 
	var re = $(this).val();
	if(re==1){
	$('.nsf2').show();
	//document.getElementById("ctrl-student_relatives_name_1").setAttribute("required", "");
    //document.getElementById("ctrl-relatives_type_1").setAttribute("required", "");
    //document.getElementById("ctrl-relative_phone_1").setAttribute("required", "");
    //alert(re);
    }else{
    //document.getElementById("ctrl-student_relatives_name_1").removeAttribute("required");
    //document.getElementById("ctrl-relatives_type_1").removeAttribute("required");
    //document.getElementById("ctrl-relative_phone_1").removeAttribute("required");
    $('.nsf2').hide();
    }
});
$('#ctrl-Do_you_have_health_issues').on('change', function(){ 
	var is = $(this).val();
	if(is==1){
	$('.nsf3').show();
   //document.getElementById("ctrl-Details_of_health_issues").setAttribute("required", "");
    }else{
   // document.getElementById("ctrl-Details_of_health_issues").setAttribute("required", "");  
     $('.nsf3').hide();
    }
});
$('#ctrl-student_college, #ctrl-student_stage ').on('change', function(){ 
	var college = $('#ctrl-student_college').val();
	var stage   = $('#ctrl-student_stage').val();
	if(college >9 & (stage ==2 || stage == 3)){
	$('.apology').show();
	document.getElementById("ctrl-apology_file").setAttribute("required", "");
	console.log('ggg');
    }else{
     $('.apology').hide();   
    }
...
"<?php echo $data['Do_you_have_relatives'] ?>");
*/
$(document).ready(function() {
    /*var ns1= document.getElementById("ns1").innerText;
    var ns2= document.getElementById("ns2").innerText;
    if(ns1=='لا يوجد')
    {
        $('.td-student_relatives_name_1').hide();
        $('.td-relatives_type_1').hide();
        $('.td-relative_phone_1').hide();
        $('.td-student_relatives_name_2').hide();
        $('.td-relatives_type_2').hide();
        $('.td-relative_phone_2').hide();
    }
        if(ns2=='لا يوجد')
    {
        $('.td-Details_of_health_issues').hide();
    }*/
 	$('.nsf1').hide();
	$('.nsf2').hide();
	$('.nsf3').hide();
    ...
    $('#i10').change(function() {
        if(this.checked) {
            var returnVal = confirm(" اطلعت على جميع التعليمات واتعهد بالالتزام بها") ;
        ...
        $('#i10').val(this.checked);        
    });
    $('#i11').change(function() {
        if(this.checked) {
             var element11 = document.getElementById("aa");
            element11.classList.remove("nsf6");
            $(this).prop("checked", returnVal);
        }
        if(this.checked==false) {
          var element11 = document.getElementById("aa");
            element11.classList.add("nsf6");
        }
        $('#i11').val(this.checked);        
    });
});
